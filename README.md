...
| หน้า | Path | บทบาท |
|------|------|--------|
| รับสินค้า | `/intake` | operator, admin, manager |
...
- หลังล็อกอิน: **operator** → `/intake`, **admin/manager** → `/history`
...
1. Push ขึ้น GitHub
2. Import ที่ [vercel.com](https://vercel.com) → **Root Directory: `web`**
